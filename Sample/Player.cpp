...
void CPlayer::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	pd3dCommandList->SetGraphicsRootConstantBufferView(0, m_d3dGpuVirtualAddress);
}
...
CTerrainPlayer::CTerrainPlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, void *pContext, int nMeshes) : CPlayer(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, pContext, nMeshes)
{
	...
	CCubeMeshDiffused *pCubeMesh = new CCubeMeshDiffused(pd3dDevice, pd3dCommandList, 20.0f, 40.0f, 20.0f);
	SetMesh(0, pCubeMesh);
	...
	SetPosition(XMFLOAT3(pTerrain->GetWidth()*0.5f, 20.0f, 250.0f));
	//SetPosition(XMFLOAT3(80.0f, 100.0f, 80.0f));
